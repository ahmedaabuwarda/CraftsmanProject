            ...
            <form class="kt-form kt-form--label-right" action="/crafts/{{ $craft->id }}" method="post">
                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ $craft->name }}" placeholder="اسم الموهبة" id="example-text-input" autofocus autocomplete>
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="describe" value="{{ $craft->describe }}" placeholder="وصف الموهبة" id="describe" autocomplete>
                            @error('describe')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
