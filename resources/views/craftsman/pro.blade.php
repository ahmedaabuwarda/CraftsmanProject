                ...
                <form class="kt-form" action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="kt-portlet__body" style="padding: 5px">
                        <div class="form-group" style="margin-bottom: 0">
                            <input class="form-control" type="text" name="title" placeholder="عنوان المنشور" id="title">
                        </div>
                    </div>
                    <div class="kt-portlet__body" style="padding: 5px">
                        <div class="form-group" style="margin-bottom: 0">
                            <textarea name="body" class="form-control" rows="3" placeholder="في ماذا تفكر {{ auth('craftsman')->user()->name }}"></textarea>
                        </div>
                    </div>
                    <div class="kt-portlet__body" style="padding: 5px">
                        <div class="form-group" style="margin-bottom: 0">
            ...
            @foreach($posts as $post )
                <div class="kt-portlet">
                    ...
                    @if($post->cover_image != 'noimage.jpg')
                        <img src="{{ asset('/storage/cover_images/' . $post->cover_image) }}" style="height:380px ; width:80%; margin-right: 10%">
                    @endif
